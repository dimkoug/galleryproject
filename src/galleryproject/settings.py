...
SECRET_KEY = ')mda#ho4$zmwoe&u$h95mc-*akh^!1%a##4nn*k^=4*t^!_-v4'
...
DATABASES = {
    "default": {
        ...
        "USER":     os.environ["POSTGRES_USER"],
        "PASSWORD": os.environ["POSTGRES_PASSWORD"],
        "HOST":     os.environ["DB_HOST"],  # should be pgbouncer_gallery
...
CELERY_BROKER_URL = "redis://redis_gallery:6379/0"
CELERY_RESULT_BACKEND = "redis://redis_gallery:6379/1"
...
CACHES = {
    "default": {
        ...
        "LOCATION": (
            f"redis://{os.getenv('REDIS_CACHE_HOST','redis_cache_gallery')}:"
